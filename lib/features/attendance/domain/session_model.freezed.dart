...
mixin _$SessionModel {
 ...
 int? get id;@JsonKey(name: 'group_id') int get groupId;@JsonKey(name: 'session_date') String get sessionDate; String? get title;@JsonKey(name: 'created_at') String get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,groupId,sessionDate,title,createdAt);

@override
String toString() {
  return 'SessionModel(id: $id, groupId: $groupId, sessionDate: $sessionDate, title: $title, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int? id,@JsonKey(name: 'group_id') int groupId,@JsonKey(name: 'session_date') String sessionDate, String? title,@JsonKey(name: 'created_at') String createdAt
});
...
/// Create a copy of SessionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? groupId = null,Object? sessionDate = null,Object? title = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'group_id')  int groupId, @JsonKey(name: 'session_date')  String sessionDate,  String? title, @JsonKey(name: 'created_at')  String createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SessionModel() when $default != null:
return $default(_that.id,_that.groupId,_that.sessionDate,_that.title,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'group_id')  int groupId, @JsonKey(name: 'session_date')  String sessionDate,  String? title, @JsonKey(name: 'created_at')  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _SessionModel():
return $default(_that.id,_that.groupId,_that.sessionDate,_that.title,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @JsonKey(name: 'group_id')  int groupId, @JsonKey(name: 'session_date')  String sessionDate,  String? title, @JsonKey(name: 'created_at')  String createdAt)?  $default,) {final _that = this;
switch (_that) {
case _SessionModel() when $default != null:
return $default(_that.id,_that.groupId,_that.sessionDate,_that.title,_that.createdAt);case _:
  return null;
...
class _SessionModel implements SessionModel {
  const _SessionModel({this.id, @JsonKey(name: 'group_id') required this.groupId, @JsonKey(name: 'session_date') required this.sessionDate, this.title, @JsonKey(name: 'created_at') required this.createdAt});
...
/// Create a copy of SessionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? groupId = null,Object? sessionDate = null,Object? title = freezed,Object? createdAt = null,}) {
